...
ALTER TABLE EMPS ADD CONSTRAINT M_PK PRIMARY KEY (M_NUM);
ALTER TABLE EMPS ADD CONSTRAINT M_UK UNIQUE (REG_DATE);
ALTER TABLE EMPS ADD CONSTRAINT M_CK CHECK IN('M','F');
ALTER TABLE EMPS ADD CONSTRAINT M_UK UNIQUE (REG_DATE);
...
ALERT TABLEE RENTALS ADD CONSTRAINT NO_PK PRIMARY KEY (RENTALS_KEY);
ALERT TABLEE RENTALS ADD CONSTRAINT N_CK CHECK (RENTALS_YN);
